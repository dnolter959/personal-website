...
Regularization is used within the context of linear regression to balance bias and variance and avoid overfitting. [This paper](regularization_paper.pdf) details the results of a simulation study to investigate the performance of LASSO, Ridge, and Elastic Net approaches on model performance under a variety of conditions (e.g., high sparsity).